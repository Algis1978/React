...
export default function VienasZveris ( {vzveris} ) {
    ...
    return (
        ...
        <div className="vienasZveris">
            ...
            <div className="atvykimodata"><span className="text">Registracijos data:</span> {vzveris["Registracijos_data"].slice(0, 10)}</div>
            ...
            <div className="islaikymas"><span className="text">Išlaikymas per mėn.:</span> {vzveris["Išlaikymo_kaina_eurais_per_mėn"]} eur</div>
        </div>
        </>
    )
}