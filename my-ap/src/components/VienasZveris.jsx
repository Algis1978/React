...
export default function VienasZveris ( {vzveris}) {
    ...
    return (
        ...
        <div className="vienasZveris">
            ...
            <div className="invnr">Inv. Nr.: {vzveris["Inv. Nr."]}</div>
            ...
            <div className="atvykimodata"><span className="text">Registracijos data:</span> {vzveris["Atvykimo data"].slice(0, 10)}</div>
