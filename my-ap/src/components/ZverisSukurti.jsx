...
export default function ZverisSukurti ( {sukurti} ) {
    ...
    return (
        ...
        <div className="zverissukurti">
            ...
            <p><span className="text">Registracijos data:</span></p><input type="text" value={inputs["Registracijos data"]} onChange={(e) => formControl(e, "Registracijos data")} require />

            <p><span className="text">Rūšis:</span></p><input type="text" value={inputs["Rūšis"]} onChange={(e) => formControl(e, "Vardas")} require />

            <p><span className="text"><label for="lytis">Lytis (pasirinkite):</label></span></p>
